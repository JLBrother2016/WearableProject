...
/**
  ...
  */
#define SDIO_INIT_CLK_DIV                ((uint8_t)0x76)			/* SDIO_CK = 48000KHz / (0x76 + 2) = 400KHz */
//#define SDIO_INIT_CLK_DIV                ((uint8_t)478)
/**
  * @brief  SDIO Data Transfer Frequency (25MHz max)
  */
#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x0)		/* 缺省是0， SDIO_CK = 48M / (0 + 2) = 24MHz*/	 
...
/****************** 下面的内容来自 stm324xg_eval_sdio_sd.h ***************************************/
...
/* Uncomment the following line to select the SDIO Data transfer mode */
	...
	#define SD_DMA_MODE                                ((uint32_t)0x00000000)				/* 使用 DMA 模式 */
